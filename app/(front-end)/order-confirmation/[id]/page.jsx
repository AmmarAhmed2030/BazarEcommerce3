...
export default async function page({ params: { id } }) {
  ...
  const subTotal = orderItems
    ...
    .toFixed(2);
  return (
    <section className="py-12 dark:bg-slate-950 bg-slate-50 text-slate-800 dark:text-slate-50 sm:py-16 lg:py-20">
          ...
          <div className="relative mt-6 overflow-hidden bg-white dark:bg-slate-700 rounded-lg shadow md:mt-10">
            <div className="absolute top-4 right-4">
              <Link
                ...
                className="inline-flex items-center justify-center w-full md:w-auto px-4 py-3 text-xs font-bold transition-all duration-200 bg-lime-500 border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime-800 hover:bg-lime-700"
              >
                View invoice
              </Link>
            </div>
